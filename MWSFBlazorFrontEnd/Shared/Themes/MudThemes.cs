        ...
        static MudThemes()
        {
            ...
            MidwestSpeedfest = new MudTheme
            {
                ...
                Palette = new Palette
                {
                    ...
                    Divider = "rgba(255,255,255, 0.90)",
                    DividerLight = "rgba(255,255,255, 0.5)",
                    TableLines = "rgba(255,255,255, 0.90)",
                    LinesDefault = "rgba(255,255,255, 0.90)",
                    LinesInputs = "rgba(255,255,255, 0.90)",
